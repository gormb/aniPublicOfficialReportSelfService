...
async function simplify(inTxt, doneC, wordCountWanted = DEFAULT_MAX_WORDS // 75 words: 100 token; 2000token=1500w
    ...
    ,promptEpi = "\n\nSummary: ")
{
    try { samleButton.innerHTML = 'Samle &#8634;';} catch (ex) { }
    ...
    alert('simplify - metoden begrenser innhold ned til ' + wordCountWanted + ' ord. Ikke ferdig impllementert, desverre...!');
