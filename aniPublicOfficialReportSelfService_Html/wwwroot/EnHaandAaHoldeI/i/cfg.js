...
const cfg = {
    ...
    , aiProvider: [ // [name, url, gunn, Spørsmålsforslag prompt, Spørsmålsforslag prompt(n), [[aiName, aiModel]]]
        ...
        , ['Together AI Completion', 'https://api.together.xyz/v1/completions', escape(`32>Q7cXQEwFg-\\Cw*_ ^YIpFI&)%l3?R9&,'5?^XV(0RT6N2:`), 'Gi meg et konkret eksempel på neste spørsmål jeg bør stille. Svar kun med spørsmålet, så jeg kan sende dette videre til en annen chat-tjeneste', 'Gi meg enda ett konkret eksempel på neste spørsmål jeg bør stille. Svar kun med spørsmålet, så jeg kan sende dette videre til en annen chat-tjeneste'
            , [['Comp Llama 3.3 70B Turbo', 'meta-llama/Llama-3.3-70B-Instruct-Turbo'], ['Comp DeepSeek V3', 'deepseek-ai/DeepSeek-V3'], ['Comp DeepSeek R1 distill Llama-70B', 'deepseek-ai/DeepSeek-R1-Distill-Llama-70B']]]
        , ['Together AI Chat', 'https://api.together.xyz/v1/chat/completions', escape(`32>Q7cXQEwFg-\\Cw*_ ^YIpFI&)%l3?R9&,'5?^XV(0RT6N2:`), 'Gi meg et konkret eksempel på neste spørsmål jeg bør stille. Svar kun med spørsmålet, så jeg kan sende dette videre til en annen chat-tjeneste', 'Gi meg enda ett konkret eksempel på neste spørsmål jeg bør stille. Svar kun med spørsmålet, så jeg kan sende dette videre til en annen chat-tjeneste'
            , [['Llama 3.3 70B Turbo', 'meta-llama/Llama-3.3-70B-Instruct-Turbo'], ['DeepSeek V3', 'deepseek-ai/DeepSeek-V3'], ['DeepSeek R1 distill Llama-70B', 'deepseek-ai/DeepSeek-R1-Distill-Llama-70B']]]
