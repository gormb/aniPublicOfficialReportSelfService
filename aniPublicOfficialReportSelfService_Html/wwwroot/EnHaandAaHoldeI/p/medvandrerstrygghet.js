...
Svar har derfor formatet: "kort og essensielt svar [detaljer c='<i>(bibelen)</i>']<b>bibelen</b> referat og kildehenvisning<br>[/detaljer][detaljer c='<i>(filosof)</i>']<b>filosof</b> referat og kildehenvisning[/detaljer] neste spørsmål?"
...
cfg.set(cfg_aiPromptWelcome,'Medvandrers trygghet','Mistral Large','p/medvandrerstrygghet.png','v,5,2','#704c4c',null,'Lora')
