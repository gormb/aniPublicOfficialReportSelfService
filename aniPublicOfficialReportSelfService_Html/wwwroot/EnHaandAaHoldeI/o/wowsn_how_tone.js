...
window.wowsn_how_tone={
    ...
    ,person: [
        ...
        /*K1*/
        // EH: Famed for his extremely concise, "iceberg theory" prose (K1), direct (U1), with simple language (S1) and a minimalist texture (X1), often from a close perspective (P8) and fact-based/observational (E7, G3)
        ['EH', 'Ernest Hemingway',        'P8,E7,U1,N8,S1,T2,F7,O2,L2,M7,R6,V6,A6,K1,X1,I6,J6,C8,D7,G3,B3,W2,Y3,Z4,Q5'],
