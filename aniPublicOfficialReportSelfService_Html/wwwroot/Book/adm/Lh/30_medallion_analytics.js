// 02_analytics.js – Lh analytics (gold) with drill-down
...
// reads from public.gold_* (serving layer) – works without exposing the gold schema
...
async function goldQ(table,opt){ // check if the public view is available
...
async function drillRender(){
  ...
  // readers who have read this book (from usage)
