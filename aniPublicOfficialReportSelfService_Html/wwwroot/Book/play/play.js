    ...
    play:{
        ...
        ,sem:{
            Z:{
                ...
                ,ib:()=>{const i=books.play.sem.Z.inv;zmI.classList.toggle('on',!!i);zmI.title='Zoom: '+(i?'up':'down')+' means into the detail – the two-finger pinch and ↑/↓ alike. Click to turn it round.';} // the ⇄ switch: the same glyph either way, only pressed or not – the title is what says which way up and down now read
